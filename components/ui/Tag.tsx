...
const TAG_COLORS: Record<string, { bg: string; color: string }> = {
  ...
  "UI/UX":           { bg: "var(--c-glass-bg)",      color: "var(--c-text-muted)" },
  ...
  "Creator Platform":{ bg: "var(--c-glass-bg)",      color: "var(--c-text-muted)" },
  ...
  "Next.js":         { bg: "var(--c-glass-bg)",      color: "var(--c-text-primary)" },
  Dashboard:         { bg: "var(--c-glass-bg)",      color: "var(--c-text-muted)" },
  SaaS:              { bg: "rgba(248,89,0,0.12)",   color: "#FF9432" },
  React:             { bg: "var(--c-glass-bg)",      color: "var(--c-text-muted)" },
  ...
  Hochschulprojekt:  { bg: "var(--c-glass-bg)",      color: "var(--c-text-muted)" },
  "Uni Project":     { bg: "var(--c-glass-bg)",      color: "var(--c-text-muted)" },
  "Proyecto Uni":    { bg: "var(--c-glass-bg)",      color: "var(--c-text-muted)" },
  StrykerLabs:       { bg: "var(--c-glass-bg)",      color: "var(--c-text-muted)" },
  Frontend:          { bg: "var(--c-glass-bg)",      color: "var(--c-text-muted)" },
};

function getTagStyle(tag: string) {
  return TAG_COLORS[tag] ?? { bg: "var(--c-glass-bg)", color: "var(--c-text-muted)" };
}
